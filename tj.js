const videoData = [
  ...
  {
    src: "videos/tj/Little Paradise.mp4",
  ...
  {
    src: "videos/tj/SARILING MUNDO.mp4",
  ...
  {
    src: "videos/tj/WALONG BILYON.mp4",
  ...
  {
    src: "videos/tj/Kung Siya Man.mp4",
...
function openVideo(id) {
    window.location.href = "tj.html?video=" + encodeURIComponent(id);
}
